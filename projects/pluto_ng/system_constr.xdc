...
set_property  -dict {PACKAGE_PIN U2    IOSTANDARD LVDS  DIFF_TERM_ADV TERM_100}  [get_ports rx1_qdata_in_n]     ; ## IO_L6P_65_RX1_QDATA_OUT_N
set_property  -dict {PACKAGE_PIN T3    IOSTANDARD LVDS  DIFF_TERM_ADV TERM_100}  [get_ports rx1_qdata_in_p]     ; ## IO_L6N_65_RX1_QDATA_OUT_P
...
# set_property  -dict {PACKAGE_PIN H1   IOSTANDARD LVDS}     [get_ports csi_cp]    ; ## IO_L1P_66_CSI_CP
# set_property  -dict {PACKAGE_PIN G1   IOSTANDARD LVDS}     [get_ports csi_cn]    ; ## IO_L1N_66_CSI_CN
# set_property  -dict {PACKAGE_PIN F4   IOSTANDARD LVCMOS18} [get_ports csi_dp0]   ; ## IO_L2P_66_CSI_DP0
# set_property  -dict {PACKAGE_PIN E4   IOSTANDARD LVCMOS18} [get_ports csi_dn0]   ; ## IO_L2N_66_CSI_DN0
# set_property  -dict {PACKAGE_PIN E2   IOSTANDARD LVCMOS18} [get_ports csi_dp1]   ; ## IO_L3P_66_CSI_DP1
# set_property  -dict {PACKAGE_PIN E1   IOSTANDARD LVCMOS18} [get_ports csi_dn1]   ; ## IO_L3N_66_CSI_DN1
# set_property  -dict {PACKAGE_PIN D4   IOSTANDARD LVCMOS18} [get_ports csi_scl0]  ; ## IO_L11P_66_CSI_SCL0
# set_property  -dict {PACKAGE_PIN D3   IOSTANDARD LVCMOS18} [get_ports csi_sda0]  ; ## IO_L11N_66_CSI_SDA0
# set_property  -dict {PACKAGE_PIN C4   IOSTANDARD LVCMOS18} [get_ports csi_gpio0] ; ## IO_L12P_66_CSI_GPIO0
# set_property  -dict {PACKAGE_PIN C3   IOSTANDARD LVCMOS18} [get_ports csi_gpio1] ; ## IO_L12P_66_CSI_GPIO1
#
# set_property  -dict {PACKAGE_PIN E6   IOSTANDARD LVDS}     [get_ports dsi_cp]    ; ## IO_L13P_66_DSI_CP
# set_property  -dict {PACKAGE_PIN E5   IOSTANDARD LVDS}     [get_ports dsi_cn]    ; ## IO_L13N_66_DSI_CN
# set_property  -dict {PACKAGE_PIN D7   IOSTANDARD LVCMOS18} [get_ports dsi_dp0]   ; ## IO_L14P_66_DSI_DP0
# set_property  -dict {PACKAGE_PIN D6   IOSTANDARD LVCMOS18} [get_ports dsi_dn0]   ; ## IO_L14N_66_DSI_DN0
# set_property  -dict {PACKAGE_PIN G5   IOSTANDARD LVCMOS18} [get_ports dsi_dp1]   ; ## IO_L15P_66_DSI_DP1
# set_property  -dict {PACKAGE_PIN F5   IOSTANDARD LVCMOS18} [get_ports dsi_dn1]   ; ## IO_L15N_66_DSI_DN1
